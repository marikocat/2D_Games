...
int main()
{
	...
	// Create a texture to hold a graphic on the GPU (graphics processing unit)
	...
	for (int i = 0; i < NUM_CLOUDS; i++)
	{
		...
		clouds[i].setPosition(-300, i * 250);
		...
		*/
		...
		if (!paused)
		{
			...
			if (logActive)
			{
				...
				// Has the log reached the left or right hand edge?
